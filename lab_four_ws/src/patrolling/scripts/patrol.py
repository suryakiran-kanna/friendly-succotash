...
def spawn():
    ...
    #node = roslaunch.core.Node(package, executable, args="-urdf -model jackal -param robot_description -x 0 -y 0 -z 1.0")
...
if __name__ == '__main__':
    try:
        ...
        rospy.loginfo("Closest waypoint is [%2.3f, %2.3f]", goal_x[startIndex], goal_y[startIndex])
        while(startIndex < NumGoals):
            moveToGoal(goal_x[startIndex],goal_y[startIndex], 30)
            rotate()
